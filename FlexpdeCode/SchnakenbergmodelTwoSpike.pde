...
b=1/2
 L=1
 v0=6*2
!u0=3/2*(1/(cosh((x-0.42)/2/0.01))^2+1/(cosh( (x+0.61)/2/0.01))^2 )/6/2! inof phase
u0=3/2*(1/(cosh((x-0.42)/2/0.01))^2+1/(cosh( (x+0.41)/2/0.01))^2 )/6/2 !out of phase
...
elevation(u0,u) from (-L) to (L) report( int2/int1) !REPORT(tau) 
